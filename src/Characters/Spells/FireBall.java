...
public class FireBall extends BaseSpell {
    ...
    public FireBall(Point currentPosition, Point position, double radius, double damage, List<BaseCharacter> targets, Pane layer, Images images) {
        super(position, radius, targets);
        this.damage = damage;
        imageView.setImage(images.fireballImage);
        this.layer = layer;
